...
type EnzymeMatchersType = {
  ...
  toContainReact(element: ReactElement<any>): void
  toExist(): void
...
interface JestExpectType {
   ...
   */
  toMatchObject(object: any | Array<any>): void
  /**
...
type JestObjectType = {
   ...
   * implementation.
   */
  fn<TArguments extends ReadonlyArray<any>, TReturn>(
   ...
   */
  mock(moduleName: string, moduleFactory?: any, options?: any): JestObjectType
  /**
   ...
   * object[methodName].
   */
  spyOn(object: any, methodName: string, accessType?: 'get' | 'set'): JestMockFn<any, any>
  /**
...
declare function afterEach(
  fn: (done: JestDoneFn) => Promise<unknown> | undefined | null,
  timeout?: number
): void
...
declare var describe: {
  ...
  each(
    ...
    name: JestTestName,
    fn?: (...args: Array<any>) => Promise<unknown> | undefined | null,
    timeout?: number
  ) => void
...
type JestPrettyFormatIndent = (a: string) => string
type JestPrettyFormatRefs = Array<any>
type JestPrettyFormatPrint = (a: any) => string
...
declare function spyOn(value: unknown, method: string): any
